...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        template: '<ul class="pagination uk-pagination">' +
                '<li v-if="! has_previous" class="disabled uk-disabled"><span aria-hidden="true" ><i class="uk-icon-angle-double-left"></i>«</span></li>' +
                '<li v-if="has_previous"><a v-attr="onclick:\'gotoPage(\' + (page_index-1) + \')\'" href="#0"><i class="uk-icon-angle-double-left"></i><span aria-hidden="true" >«</span></a></li>' +
                '<li class="active uk-active"><span v-text="page_index || 1"></span></li>' +
                '<li v-if="! has_next" class="disabled uk-disabled"><span><i class="uk-icon-angle-double-right"></i>»</span></li>' +
                '<li v-if="has_next"><a v-attr="onclick:\'gotoPage(\' + (page_index+1) + \')\'" href="#0"><i class="uk-icon-angle-double-right"></i><span aria-hidden="true" >»</span></a></li>' +
            '</ul>'
    });
}
